-- =====================================================
-- HR DATABASE - FIXED FOR POSTGRESQL / SUPABASE
-- Fixes: circular FK between departments↔employees
-- =====================================================
...
CREATE TABLE departments (
    ...
    manager_id      INTEGER,          -- FK added after employees are inserted
...
-- Add departments.manager_id FK now that employees table exists
...
-- DEPARTMENTS (manager_id = NULL — will be set after employees are inserted)
...
-- EMPLOYEES (batch 1: top-level managers first so self-referencing manager_id works)
